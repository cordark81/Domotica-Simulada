<template>
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1097 845" aria-hidden="true"
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">EDW-DOMOTIC</h2>
                <p class="mt-6 text-4xl    leading-8 text-gray-300">Preparando el Futuro</p>
            </div>
            <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
                <div
                    class="grid grid-cols-1 gap-y-6 gap-x-8 text-lg font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
                    <a @click="howIsModal = true" v-for="link in links" :key="link.name" :href="link.href">{{ link.name }}
