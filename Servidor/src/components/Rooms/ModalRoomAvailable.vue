                                ...
                                <div class="sm:flex sm:items-start">
                                    <div class="w-full text-center">
                                        <div>
                                            ...
                                            <roomsAvailable v-for="room in store.seeRooms" :key="room.id" :name="room.nombre" />
                                            <button @click="emits('closeModal')"
                                                class="w-24 ml-5 text-white bg-red-400 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Cancelar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
import roomsAvailable from './roomsAvailable.vue'
